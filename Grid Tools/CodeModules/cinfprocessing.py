...
# This file was *autogenerated* from the file cinfprocessing.sage
from sage.all_cmdline import *   # import sage library

_sage_const_12 = Integer(12); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_4 = Integer(4); _sage_const_99 = Integer(99); _sage_const_100 = Integer(100); _sage_const_3 = Integer(3)
...
TIMERS = True
PROCESSOR_COUNT = _sage_const_12 
...
#         return
    ...
    def split_by_grading(self, partition_list, key):
        ...
        for data in partition_list:
            gens = [vert for vert in self.comp.nodes() if ((self.comp.nodes()[vert][key] >= data[_sage_const_0 ]) and (self.comp.nodes()[vert][key] <= data[_sage_const_4 ])) ]
...
#########################################
    ...
    def parallel_graph_single_split(self, key, split_count, split_blocks = None):
        ...
        for split in split_blocks:
            ...
            current_subgraph = []
            vertex_set = []
            vertex_set = [vert for vert in self.comp.nodes() if ((self.comp.nodes()[vert][key] >= split[_sage_const_0 ]) and (self.comp.nodes()[vert][key] <= split[-_sage_const_1 ]))]
    ...
    def grading_parallel_graph_red_search(self, proc_count = _sage_const_2 , splitting_key = "AGrading"):
        ...
        target_loop = math.ceil((_sage_const_1 +self.max_gradings[key]-self.min_gradings[key])/step)
        print(str(target_loop) + str(" target number of loops"))
        
        partition = subgraph_set[:][_sage_const_1 ]
        ...
        for i in range(target_loop):
            ...
            subgraph_set = self.parallel_graph_single_split(splitting_key, proc_count - _sage_const_1 , split_blocks = partition)
#             iterate the split
    ...
    def ego_parallel_sweep(self, start_vert = None, proc_count = _sage_const_2 ):
